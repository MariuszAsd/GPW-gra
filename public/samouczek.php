...
$kroki = [
    ...
    ['⚔️', 'Liga: Wyzwania, Ranking, Sezon',
     'Zakładka LIGA (dolny pasek / rail) zbiera całą rywalizację. WYZWANIA: wpłacasz buy-in na ODDZIELNY portfel i przez kilkanaście sesji ścigasz się o pulę (dzieli ją top ~20%). Wystarczy, że zapiszesz się sam — brakujący skład dopełniają FUNDUSZE GRY, więc edycja zawsze startuje i zawsze masz rywali. RANKING: kto ma największy kapitał. SEZON: punkty z edycji ligi i karnet. Przełączasz je podzakładkami na górze.',
     'wyzwania.php', 'Wejdź do Ligi'],
    ['🔄', 'Czas na cel minął? Nowa próba',
     'Na milion masz limit sesji. Nie zdążysz — nic straconego: w Portfelu (sekcja Cel gry) klikasz NOWA PRÓBA i dostajesz świeży zegar oraz wynik % liczony od bieżącego kapitału. Majątek, odznaki i historia konta zostają. W Rankingu przy nicku pojawia się numer próby — droga do celu jest zawsze otwarta.',
     'portfolio.php', 'Sprawdź swój cel gry'],
