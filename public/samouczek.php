...
$kroki = [
    ...
    ['🏁', 'Sezon i karnet',
     'Edycje ligi (serii wyzwań) dają punkty sezonowe za zajęte miejsca. Punkty odblokowują progi nagród w żetonach — każdy ma ścieżkę darmową, a karnet premium dokłada drugą, hojniejszą (z tytułem „Legenda Sezonu" na końcu).',
    ...
    ['🔥', 'Codzienne nagrody: seria i misje',
     'Samo wejście do gry podbija serię: +1 żeton dziennie i bonus +3 co siódmy dzień z rzędu (przerwa zeruje). Do tego trzy misje dnia na Pulpicie — wspólne dla wszystkich graczy, każda płaci żetonami. Podaj też e-mail w Ustawieniach konta, żeby nie stracić konta przy zapomnianym haśle.',
