...
final class EventCatalog
{
    public static function all(): array
    {
        return [
            // ================= RYNEK (globalne) =================
            'krach' => [
                'kind' => 'fundamental', 'scope' => 'MARKET', 'type' => 'NEG', 'impact' => -1.5, 'duration' => 20, 'weight' => 4,
            ...
            'hossa' => [
                'kind' => 'fundamental', 'scope' => 'MARKET', 'type' => 'POS', 'impact' => 1.2, 'duration' => 20, 'weight' => 4,
            ...
            'stopy_gora' => [
                'kind' => 'fundamental', 'scope' => 'MARKET', 'type' => 'NEG', 'impact' => -0.4, 'duration' => 15, 'weight' => 6,
            ...
            'stopy_dol' => [
                'kind' => 'fundamental', 'scope' => 'MARKET', 'type' => 'POS', 'impact' => 0.4, 'duration' => 15, 'weight' => 6,
            ...
            'inflacja_gora' => [
                'kind' => 'fundamental', 'scope' => 'MARKET', 'type' => 'NEG', 'impact' => -0.35, 'duration' => 15, 'weight' => 6,
            ...
            'pmi_rekord' => [
                'kind' => 'fundamental', 'scope' => 'MARKET', 'type' => 'POS', 'impact' => 0.35, 'duration' => 15, 'weight' => 6,
            ...
            'kryzys_energetyczny' => [
                'kind' => 'fundamental', 'scope' => 'MARKET', 'type' => 'NEG', 'impact' => -0.5, 'duration' => 18, 'weight' => 4,
            ...
            'pakiet_stymulacyjny' => [
                'kind' => 'fundamental', 'scope' => 'MARKET', 'type' => 'POS', 'impact' => 0.5, 'duration' => 18, 'weight' => 4,
            ...
            // ================= SEKTOR (cel: branża) =================
            'sector_panic' => [
                'kind' => 'fundamental', 'scope' => 'SECTOR', 'type' => 'NEG', 'impact' => -1.5, 'duration' => 15, 'weight' => 5,
            ...
            'sector_boom' => [
                'kind' => 'fundamental', 'scope' => 'SECTOR', 'type' => 'POS', 'impact' => 1.3, 'duration' => 15, 'weight' => 5,
            ...
            'regulacje' => [
                'kind' => 'fundamental', 'scope' => 'SECTOR', 'type' => 'NEG', 'impact' => -0.9, 'duration' => 15, 'weight' => 6,
            ...
            'przelom_w_branzy' => [
                'kind' => 'fundamental', 'scope' => 'SECTOR', 'type' => 'POS', 'impact' => 0.9, 'duration' => 15, 'weight' => 6,
            ...
            'moda_inwestorow' => [
                'kind' => 'sentiment', 'scope' => 'SECTOR', 'type' => 'POS', 'impact' => 1.4, 'duration' => 12, 'weight' => 4,
            ...
            'peka_banka' => [
                'kind' => 'fundamental', 'scope' => 'SECTOR', 'type' => 'NEG', 'impact' => -1.8, 'duration' => 12, 'weight' => 0,
            ...
            'kryzys_zaufania_fin' => [
                'kind' => 'fundamental', 'scope' => 'SECTOR', 'type' => 'NEG', 'impact' => -1.2, 'duration' => 15, 'weight' => 0,
            ...
            'kontrakt' => [
                'kind' => 'fundamental', 'scope' => 'COMPANY', 'type' => 'POS', 'impact' => 1.2, 'duration' => 10, 'weight' => 8,
            ...
            'nowy_produkt' => [
                'kind' => 'fundamental', 'scope' => 'COMPANY', 'type' => 'POS', 'impact' => 1.0, 'duration' => 10, 'weight' => 7,
            ...
            'afera_ksiegowa' => [
                'kind' => 'fundamental', 'scope' => 'COMPANY', 'type' => 'NEG', 'impact' => -2.0, 'duration' => 12, 'weight' => 4,
            ...
            'cyberatak' => [
                'kind' => 'fundamental', 'scope' => 'COMPANY', 'type' => 'NEG', 'impact' => -1.0, 'duration' => 8, 'weight' => 5,
            ...
            'rekomendacja_kupuj' => [
                'kind' => 'sentiment', 'scope' => 'COMPANY', 'type' => 'POS', 'impact' => 0.8, 'duration' => 8, 'weight' => 8,
                'head' => '📈 Analitycy rekomendują: KUPUJ [T]',
                'body' => 'Znane biuro maklerskie podnosi wycenę spółki.',
                'effects' => [],
            ],
            'rekomendacja_sprzedaj' => [
                'kind' => 'sentiment', 'scope' => 'COMPANY', 'type' => 'NEG', 'impact' => -0.8, 'duration' => 8, 'weight' => 8,
                'head' => '📉 Analitycy tną wycenę [T]: SPRZEDAJ',
                'body' => 'Biuro maklerskie widzi ryzyka, których rynek nie wycenia.',
                'effects' => [],
            ],
            'plotka_przejecie' => [
                'kind' => 'sentiment', 'scope' => 'COMPANY', 'type' => 'POS', 'impact' => 1.0, 'duration' => 10, 'weight' => 5,
            ...
            'insider_kupuje' => [
                'kind' => 'sentiment', 'scope' => 'COMPANY', 'type' => 'POS', 'impact' => 0.5, 'duration' => 6, 'weight' => 10,
            ...
            'opoznienie_projektu' => [
                'kind' => 'fundamental', 'scope' => 'COMPANY', 'type' => 'NEG', 'impact' => -0.6, 'duration' => 8, 'weight' => 6,
            ...
            'strajk' => [
                'kind' => 'fundamental', 'scope' => 'COMPANY', 'type' => 'NEG', 'impact' => -0.5, 'duration' => 8, 'weight' => 4,
                'head' => '✊ Strajk załogi w [T]',
                'body' => 'Negocjacje płacowe trwają, produkcja stoi.',
                'effects' => [['stock', 'profit_trend', -1.0, 60]],
            ],
            'viral_kampania' => [
                'kind' => 'sentiment', 'scope' => 'COMPANY', 'type' => 'POS', 'impact' => 0.35, 'duration' => 6, 'weight' => 6,
                'head' => '📣 Kampania [T] podbija internet',
                'body' => 'Marka zyskuje rozgłos — sprzedaż powinna drgnąć.',
                'effects' => [],
            ],
            'wyciek_danych' => [
                'kind' => 'fundamental', 'scope' => 'COMPANY', 'type' => 'NEG', 'impact' => -0.5, 'duration' => 8, 'weight' => 5,
            ...
            'gra_na_spadki' => [
                'kind' => 'sentiment', 'scope' => 'COMPANY', 'type' => 'NEG', 'impact' => -0.5, 'duration' => 8, 'weight' => 4,
            ...
            'podwyzka_prognoz' => [
                'kind' => 'fundamental', 'scope' => 'COMPANY', 'type' => 'POS', 'impact' => 0.6, 'duration' => 8, 'weight' => 5,
                'head' => '📊 [T] podnosi prognozy roczne',
                'body' => 'Zarząd widzi lepszą koniunkturę, niż zakładał.',
                'effects' => [['stock', 'profit_trend', 1.5, 100]],
            ],
            'obnizka_prognoz' => [
                'kind' => 'fundamental', 'scope' => 'COMPANY', 'type' => 'NEG', 'impact' => -0.6, 'duration' => 8, 'weight' => 5,
            ...
            'targi_branzowe' => [
                'kind' => 'fundamental', 'scope' => 'SECTOR', 'type' => 'POS', 'impact' => 0.3, 'duration' => 8, 'weight' => 7,
                'head' => '🎪 Udane targi branży [T] — pełne portfele zamówień',
                'body' => 'Firmy z sektora wracają z targów z kontraktami.',
                'effects' => [],
            ],
            'raport_branzowy_pos' => [
                'kind' => 'fundamental', 'scope' => 'SECTOR', 'type' => 'POS', 'impact' => 0.4, 'duration' => 10, 'weight' => 6,
            ...
            'raport_branzowy_neg' => [
                'kind' => 'fundamental', 'scope' => 'SECTOR', 'type' => 'NEG', 'impact' => -0.4, 'duration' => 10, 'weight' => 6,
                'head' => '📉 Raport analityków: branża [T] wytraca tempo',
                'body' => 'Prognozy długoterminowe dla sektora w dół.',
                'effects' => [['sector', 'profit_climate', -0.8, 80]],
            ],
            'niedobor_kadr' => [
                'kind' => 'fundamental', 'scope' => 'SECTOR', 'type' => 'NEG', 'impact' => -0.3, 'duration' => 10, 'weight' => 5,
            ...
            'tansze_surowce' => [
                'kind' => 'fundamental', 'scope' => 'SECTOR', 'type' => 'POS', 'impact' => 0.35, 'duration' => 10, 'weight' => 5,
            ...
            'plotka_kontrakt' => [
                'kind' => 'sentiment', 'scope' => 'COMPANY', 'type' => 'POS', 'impact' => 0.8, 'duration' => 10, 'weight' => 5,
            ...
            'kontrakt_potwierdzony' => [
                'kind' => 'fundamental', 'scope' => 'COMPANY', 'type' => 'POS', 'impact' => 1.8, 'duration' => 12, 'weight' => 0,
            ...
            'kontrakt_dementi' => [
                'kind' => 'fundamental', 'scope' => 'COMPANY', 'type' => 'NEG', 'impact' => -1.4, 'duration' => 10, 'weight' => 0,
            ...
            'plotka_klopoty' => [
                'kind' => 'sentiment', 'scope' => 'COMPANY', 'type' => 'NEG', 'impact' => -0.9, 'duration' => 10, 'weight' => 4,
            ...
            'klopoty_potwierdzone' => [
                'kind' => 'fundamental', 'scope' => 'COMPANY', 'type' => 'NEG', 'impact' => -2.2, 'duration' => 14, 'weight' => 0,
            ...
            'klopoty_dementi' => [
                'kind' => 'fundamental', 'scope' => 'COMPANY', 'type' => 'POS', 'impact' => 1.3, 'duration' => 10, 'weight' => 0,
            ...
            'wielka_inwestycja' => [
                'kind' => 'fundamental', 'scope' => 'COMPANY', 'type' => 'NEU', 'impact' => 0.2, 'duration' => 10, 'weight' => 4,
            ...
            'inwestycja_owocuje' => [
                'kind' => 'fundamental', 'scope' => 'COMPANY', 'type' => 'POS', 'impact' => 1.3, 'duration' => 12, 'weight' => 0,
            ...
            // ===== NOWE: rynek i sektor =====
            'zloty_slabnie' => [
                'kind' => 'fundamental', 'scope' => 'MARKET', 'type' => 'NEU', 'impact' => 0.1, 'duration' => 12, 'weight' => 5,
            ...
            'podatek_plotka' => [
                'kind' => 'sentiment', 'scope' => 'MARKET', 'type' => 'NEG', 'impact' => -0.5, 'duration' => 12, 'weight' => 3,
            ...
            'podatek_wchodzi' => [
                'kind' => 'fundamental', 'scope' => 'MARKET', 'type' => 'NEG', 'impact' => -0.9, 'duration' => 15, 'weight' => 0,
            ...
            'podatek_wycofany' => [
                'kind' => 'fundamental', 'scope' => 'MARKET', 'type' => 'POS', 'impact' => 0.7, 'duration' => 10, 'weight' => 0,
            ...
            'dotacje_branzowe' => [
                'kind' => 'fundamental', 'scope' => 'SECTOR', 'type' => 'POS', 'impact' => 0.7, 'duration' => 12, 'weight' => 4,
            ...
            'skandal_lidera' => [
                'kind' => 'sentiment', 'scope' => 'SECTOR', 'type' => 'NEG', 'impact' => -0.6, 'duration' => 10, 'weight' => 4,
            ...
            'konsolidacja_branzy' => [
                'kind' => 'sentiment', 'scope' => 'SECTOR', 'type' => 'POS', 'impact' => 0.4, 'duration' => 10, 'weight' => 4,
