...
final class Qa
{
    ...
    private function execute(float $startingCash): void
    {
        ...
        $sid = (int) $stock['id'];
        foreach ([['/pulpit.php', 'Pulpit'], ['/samouczek.php', 'Samouczek'], ['/market.php', 'Rynek'], ['/ranking.php', 'Ranking'], ['/portfolio.php', 'Portfel'], ['/pomoc.php', 'Stop-Loss'], ['/wiadomosci.php', 'Kalendarz'], ['/wyzwania.php', 'Wyzwania'], ['/dziennik.php', 'Dziennik'], ["/stock.php?id=$sid", 'Zlecenie']] as [$path, $needle]) {
