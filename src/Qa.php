...
final class Qa
{
    ...
    private function execute(float $startingCash): void
    {
        ...
        $sid = (int) $stock['id'];
        foreach ([['/market.php', 'Rynek'], ['/ranking.php', 'Ranking'], ['/portfolio.php', 'Portfel'], ['/pomoc.php', 'Stop-Loss'], ['/wiadomosci.php', 'Kalendarz'], ["/stock.php?id=$sid", 'Zlecenie']] as [$path, $needle]) {
